...
class OsmWebViewActivity : AppCompatActivity() {
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        val notizen =
            intent.getParcelableArrayListExtra<Notiz>(
                GatherActivity.NOTIZEN
            ) ?: return
        val indexAktuelleNotiz =
            intent.extras?.getInt(GatherActivity.INDEX_AKTUELLE_NOTIZ) ?: 0

        //JavaScriptInterface zur Komunikation mit JavaScript
